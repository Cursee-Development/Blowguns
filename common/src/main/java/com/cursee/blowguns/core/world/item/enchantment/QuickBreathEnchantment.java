...
public class QuickBreathEnchantment extends Enchantment implements EnchantmentCanApply {

    public QuickBreathEnchantment(Enchantment.Rarity rarity, EquipmentSlot... applicableSlots) {
